...
function addressReq(){
    ...
    const bAddress = $('#billAdd').val();
    const bCity = $('#billCty').val();
    const bState = $('#billSt').val();
    const bCountry = $('#billCon').val();
    const bPostcode = $('#billPcd').val();

    if(bAddress == null || (bAddress.trim().length === 0)) {
        alert("Billing Address can noy be emty");
        return false;      
    } else if (bCity == null || (bCity.trim().length === 0)){
        alert("City cannot be empty");
        return false;
    } else if(bState == null || (bState.trim().length === 0)){
        alert("State cannot be empty");
        return false;
    } else if(bCountry == null || (bCountry.trim().length === 0)){
        alert("Country cannot be empty");
        return false;
    } else if(bPostcode == null || (bPostcode.trim().length === 0)){
